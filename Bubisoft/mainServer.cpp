...
void MainServer::calculate() {
    for(map<uint32_t,Client*>::iterator it = clients.begin(); it != clients.end(); ++it) { ///ha t�bb, mint k�t m�sodperce volt utolj�ra friss�tve a kliens, akkor a klienset halottnak tekintj�k
